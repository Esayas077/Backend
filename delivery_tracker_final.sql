...
--
-- Host: 127.0.0.1    Database: authen_users
-- ------------------------------------------------------
...
CREATE TABLE `deliveries` (
  ...
  CONSTRAINT `deliveries_ibfk_1` FOREIGN KEY (`assigned_driver_id`) REFERENCES `drivers` (`id`)
...
CREATE TABLE `delivery_status_updates` (
  ...
  CONSTRAINT `delivery_status_updates_ibfk_1` FOREIGN KEY (`delivery_id`) REFERENCES `deliveries` (`id`) ON DELETE CASCADE
...
-- Dump completed on 2025-07-11 12:17:45
